...
<div class="marketing-page">
    <section class="hero-banner hero-banner--home" style="background-image: url('assets/images/hero-shelf.jpg');">
        <div class="hero-banner-content">
            <div class="hero-banner-left">
                <img src="assets/images/tgg-logo.png" alt="Tampa Gaming Guild Logo" class="hero-logo" loading="lazy">
    ...
    <nav class="marketing-section-nav" aria-label="Page Sections Navigation">
        ...
        <a href="#section-library" class="section-nav-link">Game Library</a>
        <a href="#section-events" class="section-nav-link">Events</a>
    </nav>

    <section class="marketing-section" id="section-announcements">
    ...
    <footer class="marketing-footer" style="text-align: center; margin-top: 40px; padding: 20px 0 10px; border-top: 1px solid rgba(203, 213, 225, 0.6); color: #64748b; font-size: 0.88rem;">
